...
const Login = () => {
    ...
    return (
        <section className="bg-gray-50">
            <div className="flex flex-col items-center justify-start px-6 py-5 mx-auto md:h-screen lg:py-0">
                <img className="mt-3" src="../static/images/elastomer-logo.png" width={400} alt="Elastomer Solution Logo" />
                <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form autoComplete='false' className="space-y-4 md:space-y-6" onSubmit={handleSubmitEvent}>
                            <div>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Your code</label>
                                <input
                                    type="number"
                                    id="code"
                                    value={code}
