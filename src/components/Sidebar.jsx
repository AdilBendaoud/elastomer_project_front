...
function Sidebar() {
    ...
    return (
        <aside id="logo-sidebar" style={!user.roles.includes("A") ? { display: "none" } : {}} className="fixed top-0 left-0 z-0 w-64 h-screen pt-5 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
