...
function PasswordReset({ email, code }) {
    ...
    const handleSubmitEvent = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${process.env.REACT_APP_API_ENDPOINT}/Password/reset-password`, { email, "resetCode": code, newPassword });
