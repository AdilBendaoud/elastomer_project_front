...
function EmailRequest({token, email, setEmail, vesibilityFunction}) {
    ...
    const handleSubmitEvent = async (e)=>{
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${process.env.REACT_APP_API_ENDPOINT}/Password/request-password-reset`,{email});
